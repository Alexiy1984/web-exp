(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		root["MyLib"] = root["MyLib"] || {}, root["MyLib"]["index"] = factory();
})(window, function() {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Hi", function() { return Hello; });
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  let helloMessage = lodash__WEBPACK_IMPORTED_MODULE_0___default.a.join(['Hello', 'webpack'], ' ');
...
exports.Hello = function(message) {
  if (true) {
    console.log('Hello '+ message + ', build mode: ' + "none");
    console.log('Hello '+ message + ', NODE_ENV =  ' + "development");
  } else {}
}
